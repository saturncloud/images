...
# docker tag saturncloud/saturn-r:{{image_version}} 369111250314.dkr.ecr.us-east-2.amazonaws.com/saturn-r:{{image_version}}
...
# docker push 369111250314.dkr.ecr.us-east-2.amazonaws.com/saturn-r:{{image_version}}
# docker push saturncloud/saturn-gpu:{{image_version}}
# docker push saturncloud/saturnbase-gpu:{{base_image_version}}
# docker push saturncloud/saturn-r:{{image_version}}
