...
cp ./common/install-miniconda.bash ./saturnbase-julia-gpu-11.8/install-miniconda.bash
cp ./common/install-miniconda.bash ./saturnbase-julia/install-miniconda.bash
