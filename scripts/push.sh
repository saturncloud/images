...
# docker tag saturncloud/saturn-r:0.9.3.7 369111250314.dkr.ecr.us-east-2.amazonaws.com/saturn-r:0.9.3.7
...
# docker push 369111250314.dkr.ecr.us-east-2.amazonaws.com/saturn-r:0.9.3.7
# docker push saturncloud/saturn-gpu:0.9.3.7
# docker push saturncloud/saturnbase-gpu:0.9.3.7
# docker push saturncloud/saturn-r:0.9.3.7